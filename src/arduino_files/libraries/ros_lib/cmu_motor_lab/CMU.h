#ifndef _ROS_cmu_motor_lab_CMU_h
#define _ROS_cmu_motor_lab_CMU_h
...
namespace cmu_motor_lab
{
  ...
  class CMU : public ros::Msg
  {
    ...
    const char * getType(){ return "cmu_motor_lab/CMU"; };
    const char * getMD5(){ return "be9cdfeec1c60f4d26327be218060167"; };
